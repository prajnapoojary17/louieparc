            ...
            foreach ($bookings as $booking) {
                ...
                $message1 = '<html>
                        ...
                        <body>' . $logo . '<br>
                            ...
                            <h4>' . $user->firstName . ' &nbsp; ' . $user->lastName . '  has booked your spot. They will be arriving at ' . $fromdateget->format(H_I_S_A) . ' and leaving at ' . $todateget->format(H_I_S_A) . '. <br>
