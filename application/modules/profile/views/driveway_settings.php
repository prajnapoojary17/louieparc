...
<div class="main-content">
    <div class="profile-settings">
        ...
        <div class="container">
            <form class="form-horizontal drivewaySetting" name="drivewaySetting" id="drivewaySetting">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="profile-actions wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s">
                        ...
                        <p class="pull-right margin-top10 wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.5s"><a href="#" class="btn btn-brand submitBtn"><i class="icon-check22"></i>Submit</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>dashboard" class="btn btn-success btn-brand"><i class="icon-cross2"></i>CLOSE</a></p>
                    </div>
                    <div class="col-md-4">
                        <div class="driveway-contact wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s" style="margin-top:100px;">
                            ...
                            <address>                      
                                ...
                                <?php echo $streetAddress; ?> , <?php echo $route; ?><br />
